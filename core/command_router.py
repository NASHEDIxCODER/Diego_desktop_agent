...
_SIMPLE_COMMANDS = [
    ...
    (r"^open\s+(?:the\s+)?(screenshot\s*area)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*window)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*full)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*selection)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*region)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*area)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*window)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*full)$", "desktop_open", {"app": "gnome-screenshot"}),
    (r"^open\s+(?:the\s+)?(screenshot\s*selection)$", "desktop_open", {"app": "gnome-screenshot"}),
