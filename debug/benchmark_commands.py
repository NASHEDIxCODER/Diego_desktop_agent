...
def build_commands() -> List[Tuple[str, str, str]]:
    ...
    volume = [
        ...
        ("set the volume to 50 percent", "set volume to 50", "volume_set"),
        ...
        ("set the brightness to 75 percent", "set brightness to 75", "brightness_set"),
    ...
    # ── Music control ──
    music = [
        ("play music", "play_music:music", "play_media"),
        ("play some music", "play_music:music", "play_media"),
        ("play lofi", "play_music:lofi", "play_media"),
        ("play some lofi hip hop", "play_music:lofi hip hop", "play_media"),
        ("play jazz", "play_music:jazz", "play_media"),
        ("play rock", "play_music:rock", "play_media"),
        ("play classical", "play_music:classical", "play_media"),
        ("play pop", "play_music:pop", "play_media"),
        ("play the beatles", "play_music:the beatles", "play_media"),
        ("play taylor swift", "play_music:taylor swift", "play_media"),
        ("play a song", "play_music:a song", "play_media"),
        ("play my playlist", "play_music:my playlist", "play_media"),
        ("pause", "pause", "music_pause"),
        ("pause the music", "pause", "music_pause"),
        ("pause the song", "pause", "music_pause"),
        ("stop", "stop", "music_stop"),
        ("stop the music", "stop", "music_stop"),
        ("stop the song", "stop", "music_stop"),
        ("resume", "resume", "music_resume"),
        ("resume the music", "resume", "music_resume"),
        ("continue playing", "resume", "music_resume"),
        ("next", "next", "music_next"),
        ("next song", "next", "music_next"),
        ("next track", "next", "music_next"),
        ("skip", "next", "music_next"),
        ("skip this song", "next", "music_next"),
    ...
    # ── Follow-up commands ──
    followups = [
        ("open it", "open", "follow_up"),
        ("open that", "open", "follow_up"),
        ("open this", "open", "follow_up"),
        ("launch it", "open", "follow_up"),
        ("start it", "open", "follow_up"),
        ("run it", "open", "follow_up"),
        ...
        ("close that", "close", "follow_up"),
        ("close it", "close", "follow_up"),
        ("again", "again", "follow_up"),
        ("do it again", "again", "follow_up"),
        ("repeat", "again", "follow_up"),
        ...
        ("that one", "open", "follow_up"),
        ("this one", "open", "follow_up"),
        ("yes", "yes", "follow_up"),
        ("yeah", "yes", "follow_up"),
        ("sure", "yes", "follow_up"),
        ("ok", "yes", "follow_up"),
    ...
    hindi = [
        ...
        ("play music karo", "play_music:music", "play_media"),
        ("music chalao", "play_music:music", "play_media"),
        ("music chala do", "play_music:music", "play_media"),
        ("play lofi karo", "play_music:lofi", "play_media"),
        ("lofi chalao", "play_music:lofi", "play_media"),
        ("lofi chala do", "play_music:lofi", "play_media"),
